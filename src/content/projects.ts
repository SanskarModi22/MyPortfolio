...
export const projects: Project[] = [
  ...
  // ── 09 ────────────────────────────────────────────────────────────────
  {
    ...
    headline: [
      { value: "137 → 497", label: "truck-days booked a month", note: "Feb to Jun 2026, about 3.6 times. From the company's own dashboard" },
      { value: "13,801", label: "deliveries to shops", note: "₹10.95 crore of goods moved, across 48 paying distributors" },
      { value: "₹2,430 → ₹1,600", label: "cost of one trip, own truck against ours", note: "the arithmetic that made distributors switch" },
    ],
    ...
    mechanisms: [
      ...
      { title: "A failed delivery becomes information", body: "Shop closed, refused to accept, wrong address, payment not ready. A closed list of reasons rather than a free-text box, tallied and sent to the distributor's sales team, so a failure turns into something they can act on instead of goods quietly coming back. A second attempt is a priced service, not a cost we absorb." },
      { title: "Small closed vehicles, because the lane is narrow and the goods are not", body: "Three-wheelers took 98.8% of trips, because market lanes are narrow, and the body is always closed, because FMCG goods have to stay sealed and dry. Four in five vehicles run on gas, and none on petrol." },
      { title: "The cost argument that closed the sale", body: "One trip on his own truck costs ₹2,430 or more. Ours costs ₹1,600. Over twenty-two delivery days that is ₹35,200 against ₹53,500 to ₹64,500, so a distributor saves ₹18,000 to ₹41,000 a month per truck, pays nothing on idle days, and releases about ₹3 lakh that was sitting in a vehicle. That is a conversation about his money, not about our software." },
    ],
    metrics: [
      { value: "137 → 497", label: "truck-days booked a month, Feb to Jun 2026", note: "about 3.6 times. July was tracking to around 660" },
      { value: "13,801 / ₹10.95 Cr", label: "deliveries to shops, and the value of goods moved", note: "five months in Gurgaon, from the company's live dashboard on 18 Jul 2026" },
      { value: "48", label: "paying distributor customers", note: "my own query of the delivery table counts 43 distinct seller businesses at the June peak" },
      { value: "₹16.5 L / +46%", label: "fee income, and fee growth from the same customers", note: "May, June and part of July. The growth is same-customer, not new logos" },
      { value: "~89%", label: "deliveries right the first time", note: "company figure. My own query of completion across all of 2026 gives 73%, on a different definition" },
      { value: "100%", label: "of the customers who joined in May were still there in June", note: "eleven of eleven, with no discount given for it" },
    ],
    honesty:
    ...
    lessons: [
      ...
      "Sell against his cost, not your feature list. ₹2,430 against ₹1,600 is an argument a distributor can check himself.",
