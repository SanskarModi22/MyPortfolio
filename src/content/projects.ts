...
export const projects: Project[] = [
  ...
  },
  {
    ...
    short: "A year of outbound for a self-ordering kiosk company: a 118-account funnel across seven cities reviewed every week, 37 introductory calls I put on the founder's calendar, 26 hardware and POS partnership conversations, 11 sales channels tested. The funnel was large and the conversion small, and the biggest deal went to a competitor.",
    ...
    headline: [
      { value: "118", label: "accounts in the funnel", note: "seven cities, reviewed weekly from April to August 2024" },
    ...
    changes: [
      "Built the funnel from a blank sheet to 118 accounts across Delhi NCR, Bangalore, Mumbai, Kolkata, Hyderabad, Jaipur, Ahmedabad, Chennai and Pune, each with a stage and a dated next step.",
    ...
    metrics: [
      { value: "118", label: "accounts on the client dashboard", note: "44 quick-service, 12 dine-in, 7 bakery, 6 café" },
      ...
      { value: "145", label: "daily stand-ups on the calendar", note: "12 June 2024 to 17 February 2025" },
      { value: "₹22.7 L", label: "the deal that went to a competitor", note: "Burger Farm, one-time price" },
