...
export const projects: Project[] = [
  // ── 01 ────────────────────────────────────────────────────────────────
  {
    ...
    headline: [
      ...
      { value: "4.5 → 45.5", label: "carts a day in Delhi and Gurgaon", note: "31 days before against 11 days after; the whole model changed at once" },
    ],
    ...
    mechanisms: [
      ...
      { title: "A queue for broken promises", body: "We promised three to four days and ran a queue of every order past that. In the final weeks it held fifty-three orders, the oldest sixteen days old, with 22% of JIT orders rejected. That was the live problem when the company stopped." },
    ],
    metrics: [
      { value: "138 → 500", label: "carts, Delhi and Gurgaon", note: "31 days before the change against 11 days after, from the cart table" },
      { value: "₹755 → ₹379", label: "median basket", note: "smaller baskets are what removing a floor should produce" },
      { value: "73% → 45%", label: "baskets clearing the ₹500 waiver", note: "which is how I found the threshold was wrong" },
      ...
      { value: "8 days", label: "JIT ran before the company closed", note: "81 orders, ₹97,253 of order value, 22% rejected, six delivered, 51 in flight" },
    ],
    honesty:
  ...
  // ── 02 ────────────────────────────────────────────────────────────────
  {
    ...
    title: "From losing ₹196 an order to making ₹36",
    short:
    ...
    headline: [
      { value: "−₹196 → +₹36", label: "contribution per completed order", note: "Feb to Jul 2026, company P&L. The programme under it was mine" },
  ...
  // ── 05 ────────────────────────────────────────────────────────────────
  {
    ...
    tier: 1,
    themes: ["Pricing", "Growth", "Unit economics"],
    ...
    metrics: [
      ...
      { value: "2–8 points", label: "lower 30-day repeat rate after a ₹1 first order", note: "Jun: 31.5% against 39.2%. Jul: 26.8% against 28.7%. The trial bought an order, not a customer" },
    ],
    honesty:
  ...
  // ── 09 ────────────────────────────────────────────────────────────────
  {
    ...
    short:
      "A delivery service for the distributors already on our marketplace. Orders arrive as a photograph of a handwritten bill, stops are routed, every handover needs a code from both sides, and cash is tracked through three pairs of hands.",
    tier: 1,
    themes: ["Go-to-market", "Product"],
    period: "Jan – Sep 2026 · Badho",
    stack: ["Booking in the seller app", "Bill photograph to order", "Driver app and routing", "Two-party code", "Cash custody ledger", "Named failure reasons"],
    headline: [
      { value: "4 → 43", label: "distributor businesses using it", note: "Jan to Jun 2026, from the delivery table" },
      { value: "~4,100", label: "bookings in 2026", note: "3,006 delivered, a 73% completion rate", count: { to: 4100, prefix: "~" } },
      { value: "65 → 697", label: "bookings a month", note: "Jan to Jul 2026. The company's quarterly deck said trips went 259 to 438" },
    ],
    cta: "Read how a paper bill becomes a routed delivery",
    context: [
      "We had built delivery for ourselves. The distributors on our marketplace had the same problem and were handling it worse: vehicles arranged ad hoc, no tracking, cash counted informally, no proof that anything arrived. They were already our customers for groceries. They were not our customers for logistics, and the product, the price and the sales conversation were all different.",
      "The awkward part was the paperwork. Distributors did not keep their orders in a system. They kept them on paper. Asking them to change that before we could serve them would have ended the product at the first meeting.",
    ],
    mechanisms: [
      { title: "Start where the paper is", body: "An order enters as a photograph of a handwritten bill, read into a structured delivery task, and the number of drops is counted from the invoices rather than typed in. We met the distributor where he already was instead of asking him to adopt a system first, which is the difference between a product that gets tried and one that gets explained." },
      { title: "Price by vehicle, not by the kilometre", body: "₹1,600 for a three-wheeler, ₹2,000 for a four-wheeler, with the number of vehicles available shown per day before booking. A distributor planning tomorrow wants a number he can commit to, not a meter. The pricing and the pitch to the first 128 distributors were mine." },
      { title: "A code from both sides at every handover", body: "The seller books, the system assigns a vehicle and driver, the driver follows a routed list of stops, and each handover needs a code that both people hold. Proof of delivery is checked against location before a photograph is accepted. It stops being an argument." },
      { title: "Cash through three pairs of hands", body: "Money collected on the round is tracked buyer to driver, driver to hub, hub to bank, each step a recorded transfer with an age and a difference, and bank deposits locked once entered. At no point is cash simply trusted, so a shortfall is findable instead of a rumour." },
      { title: "A closed list of reasons it failed", body: "Shop closed, customer unavailable, refused, wrong address, payment not ready, goods damaged. Named reasons, not a free-text box, because a named reason can be counted and a counted reason can be fixed. A second attempt is a priced service rather than a cost we absorb." },
      { title: "Own the routing", body: "The first version used an outside routing provider. We replaced it with our own route model in May. A third version with automatic driver allocation and ranking was finished in early September and never demonstrated running, because the company closed first." },
    ],
    metrics: [
      { value: "4 → 43", label: "distributor businesses, Jan to Jun 2026", note: "about elevenfold. 33 in July and August" },
      { value: "65 → 697", label: "bookings a month, Jan to Jul", note: "about tenfold" },
      { value: "3,006 of ~4,100", label: "delivered", note: "about 73%. 9% cancelled, 357 never left the created state" },
      { value: "128", label: "distributors in the Gurgaon launch group", note: "existing grocery customers, new product, new price" },
      { value: "₹1,600 / ₹2,000", label: "per trip, three-wheeler and four-wheeler", note: "priced by vehicle so a distributor can plan a day" },
      { value: "~2× · 259 → 438", label: "revenue and trips in one quarter", note: "the company's own review, on a small base, presented as that" },
    ],
    honesty:
      "Joint product ownership with Aditya Kumar. I owned the operating model, the failure taxonomy, the cash custody design and the seller-facing commercial side; the engineering was the delivery team's. The booking and completion counts are queried from production; the revenue figure is company reporting on a small base. Delivery success fell from near perfect to about 81% as trips quadrupled, which is the number I would want asked about. The third version's allocation was built and never shown running, and I would rather say that than imply it shipped.",
    lessons: [
      "Meet the customer at the paper. Reading a handwritten bill was the whole go-to-market.",
      "A number a customer can commit to beats a meter that is technically fairer.",
      "Name every failure. A free-text reason cannot be counted, so it never gets fixed.",
    ],
  },
...
export const heroMetrics: Metric[] = [
  { value: "−₹196 → +₹36", label: "contribution per completed order", note: "Feb to Jul 2026, company P&L. I drove the programme under it" },
