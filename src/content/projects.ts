...
export const projects: Project[] = [
  ...
  },
  {
    ...
    detail: [
      ...
      "Three apps ship from one codebase: buyer, seller and employee. Over eleven months I merged **805 of 1,613 pull requests** and cut **242 release versions**, from 7.153 to 8.255. On the production branch the gate is absolute: **204 of the 204 release merges are mine**, every one. What I did not do in that repository is write features. Under my own work email there are four non-release commits and all four are README edits. The code is the engineers’, the gate was mine, and those are different jobs. I owned the Play Store side too: listings, rollout, store-listing tests. I was the company's most frequent specification author, with **489 of 1,585 tickets, 192 of them full requirement documents**, and I wrote the release notes that told support and operations what had changed. Monthly bug inflow went from 114 to near zero, with the honest caveat that the bug list also shrank because the company shrank. I would not claim that one alone.",
    ],
  },
  {
    slug: "ai-pod",
