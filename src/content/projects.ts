...
export const projects: Project[] = [
  ...
  // ── 03 ────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { src: "/screens/ol-confirmed.webp", kind: "photo", alt: "Order confirmed message", caption: "The order-status journey I designed, first message: confirmed, with a 47-second video — don't cancel, track it in My Orders, give the OTP only on receipt, film the unboxing" },
      ...
      { src: "/screens/ol-delivery-unboxing.webp", kind: "photo", alt: "Delivery day message", caption: "Delivery day: already paid, so nothing is owed at the door — and film the unboxing so a claim can be settled fast" },
      { src: "/screens/ol-first-delivered.webp", kind: "photo", alt: "First order delivered message", caption: "The first-order variant of delivered — the moment a new buyer is asked to join the community" },
    ...
    changes: [
      ...
      "Designed the twelve-message order-status journey every buyer receives — packing, dispatch, delivery day, a failed attempt, a return, a partial order, a cancellation, a refund — in Hindi, one action per message, and sent it at WhatsApp's transactional rate, about a seventh of the marketing rate.",
