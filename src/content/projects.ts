...
export const projects: Project[] = [
  ...
  },
  {
    ...
    screens: [
      ...
      { src: "/screens/pricing-home-sabse-sasta.webp", kind: "phone", alt: "Home with the sabse sasta claim", caption: "Home, 5 Aug 2026: 'Bharat ka SABSE SASTA Wholesale Mandi' — the claim the slab logic had to make true" },
  ...
  {
    slug: "ono-gtm",
    title: "Ran go-to-market for a restaurant-tech company: 118 accounts, 57 companies met, a handful signed",
    short: "A year of outbound for a self-ordering kiosk company: a funnel of 118 parent restaurant chains across India reviewed every week, 37 introductory calls I put on the founder's calendar, 26 hardware and POS partnership conversations, 11 sales channels tested. The funnel was large and the conversion small.",
    lede: "Go-to-market and market research, January 2024 to February 2025, full-time. I built and ran the funnel, booked and sat in the meetings, tested the channels, and wrote every follow-up.",
    tier: 2,
    ...
    changes: [
      ...
      "Opened 26 hardware, POS and reseller conversations — POSBANK, Posiflex, Stallion, Reelo, Petpooja, i4t, Flamboyant, IMU Tech, QueueBuster — because their customers were our prospects.",
    ...
    metrics: [
      { value: "118", label: "parent restaurant chains on the client dashboard", note: "the national chains — Subway, Baskin Robbins, Costa, Barista, Wow Momo, Popeyes, Papa John's, BBQ Nation, Jubilant's Hong's Kitchen, Biryani By Kilo — across seven cities" },
  ...
  {
    slug: "whatomate",
    title: "Took WhatsApp sending in-house — a spend cap, an auto-stop on price flips, and ₹0.115 a message",
    short: "The vendor took a cut on every message and kept sending when Meta re-priced a template mid-run at seven times the cost. I wrote the plan to replace it with a self-hosted platform on Meta's own API, named the four controls it had to have, and ran the migration and the first 168,900 messages.",
    lede: "Unit economics and product. I owned the decision, the plan, the four controls, the templates, the migration and the operation; one of the changes shipped is mine. The platform was adapted from open source and extended to the plan in 75 changes over eight days.",
    tier: 1,
    themes: ["Unit economics", "Product", "Built it myself"],
    period: "Aug – Sep 2026 · Badho",
    stack: ["Meta Cloud API", "Self-hosted sender", "Spend cap", "Auto-stop on re-pricing", "Click tracking", "CSV variable mapping", "Partner API to the CRM"],
    screens: [
      { src: "/screens/wm-before-aisensy.webp", kind: "desktop", alt: "Vendor dashboard for one campaign", caption: "The vendor's view of one send: 15,423 messages billed as marketing at ₹16,811 beside 19,894 as utility at ₹2,885, and 27% failed", tag: "before" },
      { src: "/screens/wm-dashboard.webp", kind: "desktop", alt: "In-house platform dashboard", caption: "The in-house platform's first month: 168,900 messages, 1,600 active contacts, 14 campaigns" },
      { src: "/screens/wm-templates.webp", kind: "desktop", alt: "Template list", caption: "Approved templates on the Badho Wholesale number — every campaign template a utility template, on purpose" },
      { src: "/screens/wm-template-editor.webp", kind: "desktop", alt: "Template editor", caption: "A template I wrote for the Delhi–Gurgaon launch: positional variables, a tracked deep link into the app, and Meta's edit limits beside it" },
      { src: "/screens/wm-campaigns.webp", kind: "desktop", alt: "Campaign list", caption: "Launch week: 20,000-recipient geography batches for Delhi and Gurgaon, and one campaign triggered from the CRM" },
      { src: "/screens/wm-campaign-detail.webp", kind: "desktop", alt: "One campaign", caption: "One batch: 20,116 recipients, 16,951 delivered, 8,418 read — with the estimated cost shown before Start" },
      { src: "/screens/wm-insights.webp", kind: "desktop", alt: "Meta insights per campaign", caption: "Meta's own numbers per campaign over 30 days: 163,830 sent, 131,070 delivered, 70,926 read" },
      { src: "/screens/wm-chat.webp", kind: "desktop", alt: "Inbox thread", caption: "The inbox: a shopkeeper sending his list in Hinglish, our volume-slab offer going out on the same thread" },
    ],
    ...
    features: [
      ...
      { title: "A campaign that stops itself", body: "When Meta reclassifies a template, the webhook pauses every in-flight campaign on it and blocks Start and Resume until someone acknowledges the new price." },
      ...
      { title: "The CRM as the audience engine", body: "The notification platform picks a number, a template and an audience and sends through one call, with an idempotency key so a retry cannot double-send. Scheduling stays with the CRM." },
      { title: "Templates versioned, not edited", body: "Meta allows ten edits a month and one a day, with re-review on each, so templates go v1 to v2 instead of being changed in place." },
    ],
    changes: [
    ...
    solved: [
      ...
      "Solved — a retry cannot double-send, and the CRM sends WhatsApp on the same audiences it uses for push.",
  ...
  },
  {
    ...
    title: "Designed everything a buyer hears after he orders — twelve WhatsApp messages and a call that keeps him at the shop",
    short: "After the order, the buyer went quiet on us and we on him: prepaid parcels refused at the door, riders arriving at a closed shutter, claims with no proof. I designed the twelve-message order-status journey on WhatsApp, the confirmation video, and an automated reminder call that dials the buyer the moment his order is out for delivery — 1,911 orders called in five weeks, three in four reached.",
    lede: "Post-order support and return prevention. I designed the messages, briefed the video, wrote the call spec and the retry logic, ran the script review and set the monitoring.",
    tier: 1,
    ...
    screens: [
      { src: "/screens/ol-confirmed.webp", kind: "photo", alt: "Order confirmed message", caption: "Confirmed, with the 47-second video: don't cancel, track it in My Orders, give the OTP only on receipt, film the unboxing" },
      ...
      { src: "/screens/ol-dispatched.webp", kind: "photo", alt: "Order dispatched message", caption: "Dispatched: factory to delivery hub, an expected date, and the one ask — pick up the delivery boy's call" },
      ...
      { src: "/screens/ol-delivery-unboxing.webp", kind: "photo", alt: "Delivery day message with unboxing ask", caption: "The same message with the unboxing ask: film the parcel opening so a wrong, short or broken item is settled fast" },
      ...
      { src: "/screens/ol-first-delivered.webp", kind: "photo", alt: "First order delivered message", caption: "The first-order variant — the moment a new buyer is most likely to join the community" },
    ...
    features: [
      ...
      { title: "A call that rings when the parcel leaves", body: "A database trigger on out-for-delivery inserts the call. It is dialled inside 09:00–21:00 IST or held for the morning. One row per order, date and attempt, so a duplicate dial is impossible." },
      ...
      { title: "Every call logged and priced", body: "Status, attempt, duration and ₹0.30 a call on every row, a provider webhook for answered calls, and an admin dashboard with hit rate, first-attempt answer rate, cash versus prepaid, and retry performance." },
    ],
    changes: [
    ...
    takeaways: ["Tell him what is happening and ask for one thing.", "The riskiest moment needs a phone that rings, not another message."],
  },
  {
    ...
    lede: "Built it myself, end to end: the theme, the catalogue pipeline, checkout, the pixel, lead capture, the review, the reconciliation of the numbers, and the decision to stop.",
    tier: 2,
    ...
    screens: [
      { src: "/screens/sh-entry.webp", kind: "phone", alt: "Storefront entry popup", caption: "The first screen: four promises and no login — a shopkeeper browses before he tells us anything" },
      { src: "/screens/sh-home-categories.webp", kind: "phone", alt: "Category grid", caption: "Category first, brand second — the way a shopkeeper thinks about his shelf" },
      { src: "/screens/sh-combo-cards.webp", kind: "phone", alt: "Combo cards", caption: "A trial combo card: what is inside, how many of each, and the margin badge in green" },
      { src: "/screens/sh-pdp-margin.webp", kind: "phone", alt: "Product page with margin table", caption: "The conversion device: buy for ₹806, sell for ₹1,120, earn ₹313 — the store never says 'you save'" },
      { src: "/screens/sh-category.webp", kind: "phone", alt: "Category page", caption: "A category page: chips to switch, and a note that quantities are already set for a shop" },
      { src: "/screens/sh-search.webp", kind: "phone", alt: "Search results", caption: "Search that reads Hindi titles against English queries" },
      { src: "/screens/sh-brand-strips.webp", kind: "phone", alt: "Brand strips", caption: "Brand strips ranked on the last ninety days of sales, so a dormant brand never takes shelf space" },
      { src: "/screens/sh-cart.webp", kind: "phone", alt: "Cart with coupons", caption: "The cart: one coupon at a time, tap to switch" },
      { src: "/screens/sh-checkout.webp", kind: "phone", alt: "Checkout", caption: "Checkout as a guest: free 7–10 day delivery, Cashfree or cash on delivery — the phone number comes last" },
      { src: "/screens/sh-cashfree.webp", kind: "phone", alt: "Cashfree payment page", caption: "Cashfree: UPI, cards, wallets, net banking" },
      { src: "/screens/sh-wa-popup.webp", kind: "phone", alt: "WhatsApp lead capture", caption: "Lead capture asks for a WhatsApp number, not an email, with a two-minute hold and five triggers behind it" },
      { src: "/screens/sh-exit-survey.webp", kind: "phone", alt: "Leaving checkout survey", caption: "Leaving checkout? One question, so a missing payment mode is not a silent loss" },
      { src: "/screens/sh-desktop-products.webp", kind: "desktop", alt: "Store at desktop width", caption: "The same store at desktop width: 33 combos, filters, and the case-multiple note" },
    ],
    ...
    headline: [
      ...
      { value: "0", label: "orders worth counting", note: "first store shut 10 June, second paused 7 July" },
    ],
    flow: [
    ...
    features: [
      ...
      { title: "Combo cards that show what is inside", body: "Component thumbnails, ×N burst badges, a green margin badge, the brand's logo, price against MRP — every card driven by seven product metafields, so a catalogue import fills the store." },
      ...
      { title: "Coupons you switch, not stack", body: "One offer at a time, tap to switch, removed on its own when the cart drops below the offer's floor." },
      { title: "A WhatsApp number, not an email", body: "Lead capture with five triggers — an engagement gate, exit intent, idle, a cart below the minimum, an active scroller who has not clicked — a countdown hold, and a workaround for Shopify silently dropping phone-only submissions." },
      ...
      { title: "A catalogue pipeline, not a spreadsheet", body: "Shopify's own export parsed back into structured pricing, combos rebuilt as JSON, imported with their metafields; the theme checked at zero errors before every push, and the live theme never written to directly." },
    ],
    changes: [
      ...
      "Wrote the review brief for the product, catalogue and design teams — review on a phone, not a desktop, because every visitor comes from Instagram — and got it signed off.",
    ...
    metrics: [
      ...
      { value: "7", label: "product metafields driving every card and page" },
