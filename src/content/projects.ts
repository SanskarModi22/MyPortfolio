...
export const projects: Project[] = [
  ...
  // ── 04 ────────────────────────────────────────────────────────────────
  {
    ...
    mechanisms: [
      ...
      { title: "Something switched the top of the home screen off", body: "In the week of 20 July 2026 every fold at the top of the home screen falls 95 to 97% and never recovers, while brand shelves further down the same screen carry on serving 17,700 buyers a month. So it is not a tracking gap. The configuration still lists those folds as active, at unchanged priorities, with no version or date gating that would explain it. I do not know the cause and I am not going to invent one. It is the sort of thing a weekly check on your own surfaces catches in days, and nobody was running that check, me included." },
    ...
    metrics: [
      ...
      { value: "11.5h → 2.44h", label: "median time to a reply the buyer could see", note: "January to July 2026, reconstructed from ticket notes. The support number I would defend" },
