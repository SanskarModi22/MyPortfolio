...
export const projects: Project[] = [
  ...
  },
  {
    ...
    short: "206 million notifications in a quarter, half never reaching a phone and 0.33% of the rest opened. I measured the funnel, found that sending less was beating sending more, and rebuilt the programme: seven daily slots, a cap per buyer, offers verified live, and copy a shopkeeper acts on.",
    lede: "Growth. I owned push end to end — the measurement, the sending system's design, the audiences, the schedule and the copy.",
    tier: 1,
    themes: ["Growth", "Product"],
    period: "Jul – Sep 2026 · Badho",
    stack: ["Funnel measurement", "Audience presets", "Seven daily slots", "Cap per buyer", "Holdouts", "Verified-live copy"],
    screens: [
      { src: "/screens/notif-audiences.webp", kind: "desktop", alt: "Audience console", caption: "31 audiences, each a question with a number on it" },
      { src: "/screens/notif-templates.webp", kind: "desktop", alt: "Template library", caption: "The template library — content separate from audience, reusable across a week's slots" },
    ],
    headline: [
      ...
      { value: "7 slots", label: "fixed daily send times, one message each", note: "11:00 to 23:30, with a cap per buyer and a holdout" },
    ],
    flow: [
      { kind: "problem", title: "The main way the company talked to its buyers was mostly noise", body: "Push notifications were how Badho reached its 1.17 million shopkeepers every day — the gift ladder, discounts, new brands, market prices all went out this way. Over ninety days, 206 million were sent. Half never arrived on a phone at all, and of the ones that did, 0.33% were opened, against 4–8% for the industry." },
      { kind: "diagnosis", title: "Two problems, not one — and the copy was promising things that did not exist", body: "Delivery — half of sends never reaching the device — is a technical fault no copy can fix. Engagement is what content and cadence can move, and the data pointed at volume: the weeks with the most sends had the worst open rates and the quieter weeks the best. Sending less was beating sending more. And the copy bank still pitched a first-order code, a night offer, a ₹1 deal and referral rewards — all of them dead, one for ten months." },
      { kind: "decision", title: "Rebuild the programme, not the copy", body: "Separate who we message from what we say, so one audience can carry a week's schedule and the total a buyer will receive is visible before anyone presses send. Seven fixed daily slots, one message each, a cap of 8–10 per buyer per day, and a holdout group on every audience so each send can be measured. Copy rules a shopkeeper responds to: lead with the number, one action, no invented urgency. And every offer, brand and game checked live in the database before it is written into a notification." },
      { kind: "outcome", title: "A programme that could be trusted", body: "The sending system specified and built, 31 audiences each defined as a question with a number, a five-by-seven schedule of notifications built only on offers verified live that morning, and the delivery fault handed to the app team as a separate problem. WhatsApp was built alongside it for the reach push could not give." },
    ],
    changes: [
      ...
      "Specified the sending system: audiences and content as separate, reusable pieces; a weekly grid of seven slots; a cap of 8–10 messages per buyer per day; a holdout on every audience.",
      ...
      "Wrote the twelve order-status WhatsApp messages: one per order per stage.",
    ],
    metricsTitle: "How push was performing, and what changed",
    metrics: [
      { value: "2.3 M", label: "notifications sent a day", note: "90-day average" },
      ...
      { value: "0.29–0.32% vs 0.37–0.43%", label: "open rate in the heaviest weeks vs the lightest" },
      { value: "6", label: "dead offers found and removed from the schedule", note: "a first-order code, a night offer, a ₹1 deal, referral rewards, retired codes, renamed games" },
      { value: "31", label: "audiences, each a question with a number" },
      { value: "8–10", label: "notifications a buyer can receive in a day, at most" },
    ],
    solved: [
      "Solved — the company could see how many messages a buyer would get before sending, not after.",
    ...
    takeaways: ["Sending less can beat writing better.", "Check the offer is live before you write the notification."],
  },
  {
    slug: "ai-pod",
