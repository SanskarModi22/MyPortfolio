...
export const projects: Project[] = [
  ...
  {
    slug: "move-it-daas",
    title: "Built a delivery service for FMCG distributors — sold by the truck-day, booked from a photo of the invoice",
    short: "A distributor books a truck for the day, photographs his invoices, and the service does the rest: the route, the drops, the proof, the cash, and the money in his bank the same day. 137 → 634 truck-days a month.",
    lede: "Joint product owner with Aditya Kumar: the operating model, the seller and driver apps' behaviour, the failure taxonomy, cash custody and the commercial side.",
    tier: 1,
    ...
    screens: [
      ...
      { src: "/screens/daas-booking.webp", kind: "phone", alt: "Vehicle selection with day rates", caption: "Seller app — book a truck by the day: 3-wheeler ₹1,602, 4-wheeler ₹2,000" },
      { src: "/screens/daas-booked.webp", kind: "phone", alt: "Delivery booked confirmation", caption: "Booked: the day, the vehicle, the pickup — confirmed in the app" },
      ...
      { src: "/screens/daas-driver-bill.webp", kind: "phone", alt: "Driver photographing an invoice", caption: "Driver app — photograph the bill; 17,678 invoices were read this way" },
      { src: "/screens/daas-driver-drop.webp", kind: "phone", alt: "Driver's route: the day's stops in order", caption: "The driver's route: the day's stops in order, re-orderable by drag, a call button for each shop" },
      ...
      { src: "/screens/daas-driver-reasons.webp", kind: "phone", alt: "Why is this order undelivered — closed list of reasons", caption: "A failed drop becomes information: a closed list of reasons — shop closed, customer not available, refused, wrong address, payment not ready — tallied for the distributor's sales team" },
      { src: "/screens/daas-driver-handover.webp", kind: "phone", alt: "End of trip: driver back, route summary, start handover", caption: "End of the trip: orders delivered, orders coming back, cash collected — and the handover to the distributor begins" },
      { src: "/screens/daas-driver-otp.webp", kind: "phone", alt: "Rider ko OTP bataiye — the code the distributor reads to the driver", caption: "Closing the trip: a code the distributor reads to the driver, so the handover is confirmed by both sides" },
      { src: "/screens/daas-ops-dashboard.webp", kind: "desktop", alt: "Delivery management dashboard", caption: "The operations dashboard: every trip, every drop and its status — where routes are re-ordered by drag" },
    ],
    ...
    features: [
      ...
      { title: "A failed drop becomes information", body: "When a delivery fails the driver picks a reason from a closed list — customer not available, wrong address, refused, payment not ready — and the tally goes to the distributor's sales team so they can act on it. A second attempt is a priced service." },
  ...
  // ── 08 ────────────────────────────────────────────────────────────────
  {
    ...
    short: "Four ways of paying shopkeepers to come back — a gift ladder, a daily reward, free wallet credit, referral cash — measured for the first time against the only thing that matters, whether the shopkeeper orders again. One worked. The money moved to it.",
    ...
    changes: [
      ...
      "Measured the ₹75 credit run — 609,245 shopkeepers credited, 342 spent it, first orders unchanged — and stopped it rather than repeat it.",
  ...
  },
  {
    ...
    title: "Rebuilt push notifications for 1.17 million shopkeepers — as a product that never touches the live app",
    short: "206 million notifications in a quarter, half never reaching a phone, 0.33% of the rest opened — and every one of them costing the live app four database writes. I measured it, specified the rebuild, and got a sending platform built in eight weeks: countable audiences, a weekly slot grid, a dry run before every send, and zero writes to the app shopkeepers order through.",
    lede: "Growth and product. I owned the measurement, the specification, the audiences, the schedule and the copy; the platform was built to it over 158 changes between July and September.",
    tier: 1,
    themes: ["Growth", "Product"],
    ...
    screens: [
      { src: "/screens/notif-audiences.webp", kind: "desktop", alt: "Audience console", caption: "Audiences: each one a question with a number on it — how many shopkeepers, how many reachable" },
      { src: "/screens/notif-cohort.webp", kind: "desktop", alt: "Building a cohort", caption: "Build an audience from the buyer snapshot — cart value, last order, city, gift-scheme level" },
      ...
      { src: "/screens/notif-edit-template.webp", kind: "desktop", alt: "Editing a template", caption: "A template with variables — the shopkeeper's own gap to his next gift, his wallet balance — and a deep link into the app" },
      { src: "/screens/notif-schedule.webp", kind: "desktop", alt: "Weekly schedule", caption: "The weekly schedule: fixed slots, one message each, the total per buyer visible before anything sends" },
    ],
    headline: [
    ...
    flow: [
      ...
      { kind: "diagnosis", title: "Three problems, not one", body: "Delivery — half of sends never reaching the device — a technical fault no copy can fix. Engagement — the heaviest weeks had the worst open rates, so sending less was beating sending more, and the copy bank was still promising a first-order code, a night offer, a ₹1 deal and referral rewards that were all dead. And the plumbing — the sending path was built for one notification at a time, not a million, and put the live app at risk every time marketing pressed send." },
    ...
    features: [
      { title: "A campaign never touches the live database", body: "A nightly copy of 684,000 buyers is built from a read replica, and sending goes straight to Firebase. The old path wrote four rows to the app's database per recipient; the new one writes none." },
      { title: "Audiences you can count", body: "Reusable cohorts — a stranded cart, a first order never placed, a lapsed buyer, a shopkeeper one level away from a gift — each with a reachable-buyer count and a fixed holdout share, so every send can be measured against a group that did not get it." },
      ...
      { title: "Dead phones removed for good", body: "Tokens Firebase rejects are suppressed permanently and never sent to again, so the count of what was sent stops lying about what could arrive." },
    ...
    changes: [
      ...
      "Defined 31 audiences — a stranded cart, a first order never placed, a lapsed buyer, an unused wallet credit — each as a question with a number on it.",
