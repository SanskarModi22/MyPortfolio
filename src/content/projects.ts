...
export const projects: Project[] = [
  // ── 01 ────────────────────────────────────────────────────────────────
  {
    ...
    mechanisms: [
      { title: "The marketplace was not actually charging anything", body: "This is the fact that makes becoming the seller unavoidable, and I only established it by querying the whole history. Across **622,008 fulfilled orders on the old marketplace, 736 carry any commission at all**, and **2 of 5,151 sellers ever had a commission slab configured.** A take rate of two ten-thousandths of one per cent. The model on the slide was commission on order value; the model in the database was free order routing. So there was no revenue line to defend and no profit-and-loss to reconstruct for 2023 to 2025, because nothing was ever billed. If you are not charging for the transaction, the only way to earn is to own the goods, and that is the pivot." },
      { title: "The order count had always been flattering us", body: "One more thing the full history shows. **1.11 million orders were really about 592,000 shopping occasions**: 51.6% of consecutive orders by the same buyer are less than an hour apart, with a median gap of about fifteen minutes, because one basket split into one order per brand. Over the same period basket depth fell from 3.69 lines to 1.52 while the order count tripled. So the growth chart everyone looked at was partly an artefact of the per-brand split, and the per-brand minimums were both inflating the order count and blocking the carts. Removing them had to make the order number look worse, and it did." },
    ...
    metrics: [
      ...
      { value: "235 of 140,715", label: "old marketplace buyers who ever ordered on the replacement", note: "0.17%. The audience did not come across, and that is the honest cost of the cutover" },
      { value: "736 of 622,008", label: "old marketplace orders that carried any commission", note: "2 of 5,151 sellers ever had a slab. A take rate of 0.0002%, which is why owning the goods was the only option" },
  ...
  // ── 02 ────────────────────────────────────────────────────────────────
  {
    ...
    mechanisms: [
      ...
      { title: "What I actually inherited", body: "Worth establishing before any improvement is claimed. The original marketplace had been declining for **26 straight months** before I arrived: the share of orders that got fulfilled went 95.3% in December 2023, 82.8% in June 2024, under half by January 2025, 30.5% by September 2025, and **0.9% by February 2026.** Monthly fulfilled value fell from ₹9.8 crore to ₹53 lakh across my first five months. One mechanism explains a lot of it: in April 2025, **34.5% of every order placed was auto-cancelled because the seller never responded** — 119,373 orders in that year alone. That mechanism was then switched off rather than fixed, and the share of rejections with no reason recorded went from 53% to 96%. So the problem was not that orders were failing quietly. It was that they were failing loudly and the log had been turned off." },
      { title: "The accidental experiment that argued for our own vans", body: "In February 2026 two lanes ran side by side. The courier lane had **797 sellers and fulfilled 0.9% of its orders.** A local lane delivered by our own fleet had **8 sellers and fulfilled 87.5%.** Same company, same month, same buyers, two ways of moving a box. That lane went on to do 19,938 orders and ₹16.8 crore, holding 76 to 89% fulfilment every month to September. I did not design it as a comparison and it is the most persuasive number I have for why we stopped renting delivery and started doing it ourselves." },
    ...
    metrics: [
      ...
      { value: "95.3% → 0.9%", label: "fulfilment on the old courier lane, Dec 2023 to Feb 2026", note: "a 26-month decline I inherited. 34.5% of April 2025 orders were auto-cancelled for seller non-response" },
      { value: "87.5% vs 0.9%", label: "own-fleet lane against courier lane, February 2026", note: "8 sellers against 797, same company, same month. The case for owning delivery" },
