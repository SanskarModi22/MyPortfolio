...
export const projects: Project[] = [
  ...
  // ── 05 ────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      ...
      { src: "/screens/daas-driver-drop.webp", kind: "phone", alt: "Driver's drop card with call and directions", caption: "Each drop with a call button, directions, and the amount to collect" },
      { src: "/screens/daas-driver-otp.webp", kind: "phone", alt: "Handover OTP", caption: "A code both sides hold at every handover — proof on every drop, not only the disputed ones" },
      ...
      { src: "/screens/daas-driver-reasons.webp", kind: "phone", alt: "Why is this order undelivered — closed list of reasons", caption: "A failed drop becomes information: a closed list of reasons, tallied for the distributor's sales team" },
    ],
