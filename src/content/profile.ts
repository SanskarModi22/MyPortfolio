...
export const profile = {
  ...
  intro: [
    "One piece of context first, because it changes how every number here should be read. Badho ran two order books. The original marketplace took **886,000 orders worth about ₹1,626 crore between 2023 and 2026**, peaking at ₹69.3 crore in a single month in August 2025. It then fell 74% in October 2025, the month I joined, and was effectively dead by March 2026. Everything I worked on was the replacement: a smaller, newer book of about 20,000 orders and ₹1.96 crore. So these are the numbers of a turnaround inside a collapse, not of a business at scale.",
