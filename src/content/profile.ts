...
export const profile = {
  ...
  intro: [
    "One piece of context first, because it changes how every number here should be read. The original Badho marketplace took **1.11 million orders worth ₹1,723 crore between March 2023 and June 2026**, and peaked at **₹165 crore in June 2024 alone**. By the time I joined in October 2025 it was already 26 months into a decline nobody had stopped: the share of orders that actually got fulfilled had fallen from 95% to 30%, and it reached 0.9% by February 2026. Monthly fulfilled value went from ₹9.8 crore to ₹53 lakh in my first five months, and I inherited that on day one. Everything on this page is either that decline or the replacement built out of it, a book of about 20,000 orders. These are the numbers of a turnaround inside a collapse, not of a business at scale.",
