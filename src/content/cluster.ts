...
export const CLUSTER: ClusterNode[] = [
  ...
  { slug: "buyer-app-plg", x: 30, y: 60, z: 20, size: "md", value: "~9.8k", label: "DAU at peak" },
  { slug: "doka", x: 70, y: 60, z: 0, size: "md", value: "~$7,000", label: "cold-pitched, signed" },
  { slug: "move-it-daas", x: 81, y: 72, z: 40, size: "md", value: "4 → 43", label: "seller businesses" },
