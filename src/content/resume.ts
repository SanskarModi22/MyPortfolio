  ...
  roles: [
    {
      ...
      items: [
        ...
        { kind: "leaf", text: "Owned eleven epics for the four-person pod that shipped **20 production systems**; red-teamed the sales agent pre-launch; mandated model budget alerts. Specified vernacular search: **699,684 synonyms live**, all ingested." },
      ],
    },
    {
