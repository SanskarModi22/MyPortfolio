...
export const resume = {
  ...
  roles: [
    {
      ...
      items: [
        ...
        { kind: "sub", text: "Buyer-app product-led growth — subtraction first" },
        { kind: "leaf", text: "Removed the signup form and OTP tap, derived language from location, cut the first-order MOV to ₹300, specified cart nudges, a free-gifts engine and the 31-use-case notification programme after finding **89% of live carts sat below MOV**. DAU peaked ~9.8k and orders hit 250+/day in June (a team effort, stated as such)." },
    ...
    },
    {
      ...
      items: [
        ...
        { kind: "leaf", text: "Cold-pitched **DOKA** (Riyadh, nine branches) with a Figma prototype, priced the scope through three rounds, signed at ~$7,000 under Saudi law and delivered to iOS release approval with a two-person team — five-step cake configurator, 215-SKU POS mapping, weekly client reporting." },
  ...
  checklist: [
    ...
    { label: "All key figures present", detail: "−₹196 → +₹36 · ₹9.60 · 42.6% → 21.4% · ~9.8k DAU · 489 specs" },
