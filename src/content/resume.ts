  ...
  roles: [
    {
      ...
      items: [
        ...
        { kind: "leaf", text: "Removed the signup form and the OTP tap: registration after phone verification went **30% → 94%**, mid-form abandonment 21,064 per three weeks → 9. Set language from the shop location (wrong-language apps in non-Hindi states 38–46% → under 1%), cut the first-order minimum, and specified cart reminders, home tabs, a free-gifts engine and a support tab with a named RM for **1.47M buyers** after finding **89% of open carts sat below the minimum**. Installs reaching a first order still fell, 2.52% → 1.43%." },
        { kind: "sub", text: "Pricing and rewards — four experiments, then the query" },
        { kind: "leaf", text: "Cart coupons, item-level quantity discounts, ₹1 trial products and a funded base-price cut. Queried from production afterwards: coupon usage **6.9% to 36.6%** of orders with conversion flat, a 37-minute config change cutting item-coupon spend **45.7%** with no order loss; gift-scheme qualifiers re-ordered next month at **50% against 19%**; a ₹4.57 Cr free-credit run was spent by **0.06%** of the buyers who got it; ₹1 first orders repeated 2–8 points less." },
