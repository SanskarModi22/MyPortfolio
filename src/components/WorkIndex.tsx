      ...
      <div id="work-panel" aria-live="polite" className="relative hidden min-h-[440px] rounded-2xl border border-line bg-surface p-6 lg:sticky lg:top-24 lg:block lg:self-start">
        {current ? (
          ...
          <div key="idle" className="panel-swap">
            <p className="panel-row serif-lesson text-[26px] leading-tight text-ink sm:text-[30px]">Eleven cases. Each one says what the problem was, what changed, and what the number did afterwards.</p>
            <p className="panel-row mt-3 text-[14px] leading-relaxed text-muted">Scroll, and each case takes its turn here. Click any row for the problem, how it worked, the numbers, and what I got wrong.</p>
